...
def run_analysis():
    # Adjusted path to find your original file
    ...
    try:
        ...
        # Convert prices to numbers using the original column name
        ...
        print("="*60)
        # Showing model, market price and margin as it was before
